...
def number_guessing_game():
    ...
    game_state = {
        ...
        "max_value": 1000, # Default max guessing range for process count
        "max_attempts": 0,
    ...
    def check_guess():
        ...
        try:
            ...
            if guess >= game_state['target_number'] - 25 and guess <= game_state['target_number'] + 25:
    ...
    def setup_game():
        ...
        game_state["target_number"] = random.randint(1,1000)
